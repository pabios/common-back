 ...
 */
final class Version20240525194856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD site_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649BB1E4E52 ON user');
        $this->addSql('ALTER TABLE user DROP site_id_id');
